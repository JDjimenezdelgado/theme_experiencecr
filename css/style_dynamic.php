...
<?php if(isset($qode_options['blog_masonry_article_overlay_color']) && !empty($qode_options['blog_masonry_article_overlay_color'])) { ?>
	<?php if(isset($qode_options['blog_masonry_article_overlay_transparency']) && !empty($qode_options['blog_masonry_article_overlay_transparency'])){
...
<?php if (isset($qode_options['portfolio_shader_color']) && !empty($qode_options['portfolio_shader_color'])) { ?>
	<?php if(isset($qode_options['portfolio_shader_transparency']) && !empty($qode_options['portfolio_shader_transparency'])){
