...
$titlePage->addChild("panel8",$panel8);
	...
	$panel8->addChild("enable_title_container",$enable_title_container);
		...
		$enable_breadcrumbs = new QodeField("yesno","enable_breadcrumbs","no","Enable Breadcrumbs w.p.l.o.c.k.e.r...c.o.m","This option will display Breadcrumbs in Title Area");
